...
#ifdef _FOG_WEAKEN
    #undef UNITY_CALC_FOG_FACTOR_RAW
...
#define FRAGMENT_SETUP(x) FragmentCommonData x = \
    FragmentSetup(i.tex, i.eyeVec.xyz, IN_VIEWDIR4PARALLAX(i), i.tangentToWorldAndPackedData, IN_WORLDPOS(i), i.screenPos);
#else
#define FRAGMENT_SETUP(x) FragmentCommonData x = \
...
#define FRAGMENT_SETUP_FWDADD(x) FragmentCommonData x = \
    FragmentSetup(i.tex, i.eyeVec.xyz, IN_VIEWDIR4PARALLAX_FWDADD(i), i.tangentToWorldAndLightDir, IN_WORLDPOS_FWDADD(i), i.screenPos);
#else
#define FRAGMENT_SETUP_FWDADD(x) FragmentCommonData x = \
...
#ifdef _DITHER_ALPHA
    float4 screenPos                     : TEXCOORD9;    // screenPos.xyw | screen coordinate
#endif
