...
public class EnemyGenerator : Generator<Status>
{
    ...
    /// </summary>
    public virtual IStatus Spawn(MobParam param, Vector3 pos, IDirection dir = null, EnemyStatus.EnemyStoreData data = null)
        => GetInstance(param.prefab).InitParam(param, data).OnSpawn(pos, dir);

    /// <summary>
    /// Instantiate on the object pool specified by 'pool' parameter
    /// </summary>
    public virtual IEnemyStatus Spawn(Transform pool, MobParam param, Vector3 pos, IDirection dir, EnemyStatus.ActivateOption option, EnemyStatus.EnemyStoreData data = null)
