...
public class Summoner
{
    ...
    public IEnemyStatus Summon(EnemyType type, Pos pos, IDirection dir)
        => spawnHandler.PlaceEnemy(type, pos, dir, new EnemyStatus.ActivateOption(1.5f, 0f, false, true));

    public IEnemyStatus SummonRandom(Pos pos, IDirection dir)
        => spawnHandler.PlaceEnemyRandom(pos, dir, new EnemyStatus.ActivateOption(1.5f, 0f, false, true));
