    ...
    public virtual void ResetOrientation(DeviceOrientation orientation)
    {
        switch (orientation)
        {
            case DeviceOrientation.Portrait:
                ...
                uiRT.anchoredPosition = new Vector2(uiSize.x + 20f, uiSize.y + 360f) * 0.5f;
                break;

            case DeviceOrientation.LandscapeRight:
                uiRT.anchorMin = uiRT.anchorMax = new Vector2(1f, 0f);
                uiRT.anchoredPosition = new Vector2(-(uiSize.x + 40f + Mathf.Max(120f, Screen.width * ThirdPersonCamera.Margin)), uiSize.y + 40f) * 0.5f;
                break;
        }
